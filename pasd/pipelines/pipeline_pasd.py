...
class StableDiffusionControlNetPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    """
    _optional_components = ["safety_checker", "feature_extractor", "text_encoder", "tokenizer"]
    ...
    def _encode_prompt(
        ...
        if prompt_embeds is None:
            if self.tokenizer is None or self.text_encoder is None:
                prompt_embeds = build_null_encoder_hidden_states(
                    self.unet,
    ...
    def __call__(
        ...
        if prompt is None and prompt_embeds is None and (self.text_encoder is None or self.tokenizer is None):
            prompt_embeds = build_null_encoder_hidden_states(
                self.unet,
                batch_size=batch_size,
                device=device,
